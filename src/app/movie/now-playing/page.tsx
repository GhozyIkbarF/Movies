...
import { fetchNowPlaying } from "@/service";
...
export default function Popular() {
  ...
  return (
    <div className="flex px-5 pb-20 pt-28 min-h-screen flex-col items-center justify-center md:px-20 xl:px-32">
      <div className="grid gap-x-3 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-y-4">
